...
import __vite_glob_0_22 from './website-details.js';
import __vite_glob_0_23 from './websites-add.js';
...
const __vite_glob_0_24 = {
  [router.connect]: { stack: [__vite_glob_0_22, __vite_glob_0_23] },
      ...
      <settings-page-layout layout="gap:4">
        ...
        <section layout="column gap:4" layout@768px="gap:5">
          <div layout="row items:center gap:2">
            ...
            <ui-button>
              <a href="${router.url(__vite_glob_0_23)}">Add</a>
            </ui-button>
          </div>
          ${websites.length
            ? html`
