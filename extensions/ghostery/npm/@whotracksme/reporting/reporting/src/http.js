...
import { MultiStepDoublefetchNotSupportedError, TemporarilyUnableToFetchUrlError, UnableToOverrideHeadersError, PermanentlyUnableToFetchUrlError, RateLimitedByServerError } from './errors.js';
 ...
 */
async function anonymousHttpGet(url, params = {}) {
...
export { anonymousHttpGet, replacePlaceholders };
